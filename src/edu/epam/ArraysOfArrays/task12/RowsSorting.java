package edu.epam.ArraysOfArrays.task12;
...
//            We make UP- and DOWN-sorting the array by Bubble method:

            System.out.println("Array with UP-sorting rows looks like that: ");
            ...
            for (int rowSorting = 0; rowSorting < size; rowSorting ++) {
                ...
                for (int sorting = 0; sorting < size; sorting ++) {
                    ...
                    for (int enumenator = 0; enumenator < size - sorting - 1; enumenator ++) {
                        ...
                        if (array[rowSorting][enumenator] > array[rowSorting][enumenator + 1]) {

                            buffer = array[rowSorting][enumenator + 1];
                            array[rowSorting][enumenator + 1] = array[rowSorting][enumenator];
                            array[rowSorting][enumenator] = buffer;
                        }
                    }
            ...
            System.out.println("Array with DOWN-sorting rows looks like that: ");
